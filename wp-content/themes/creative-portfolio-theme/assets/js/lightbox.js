...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function () {
    ...
    $(
      ...
      <a class="lb-next" aria-label="Next image" href=""></a></div>
      <div class="lb-loader">
      <a class="lb-cancel"></a></div></div></div>
  ...
  Lightbox.prototype.start = function ($link) {
    ...
    this.$lightbox
      .css({
        // top: top + "px",
        left: left + "px",
        marginTop: -17 + $window.scrollTop() + "px",
      })
  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    this.$lightbox.find(".lb-image, .lb-numbers, .lb-caption").hide();
    ...
    preloader.onload = function () {
      ...
      windowWidth = ($(window).width() * 90) / 100;
      if (
